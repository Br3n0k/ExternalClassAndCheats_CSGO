        ...
        public static void Start()
        {
            if (Settings.userSettings.MiscSettings.ClanChangerTheme == Settings.ClanChangerTheme.SkeetTheme)
            {
                ...
                switch (t)
                {
                    ...
                    case 13: tag = "    Barbudon"; break;
                    case 14: tag = "   Barbudon "; break;
                    case 15: tag = "  Barbudon  "; break;
                    case 16: tag = " Barbudon   "; break;
                    case 17: tag = "Barbudon    "; break;
