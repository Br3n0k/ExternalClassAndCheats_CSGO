        ...
        public static void Start()
        {
            if (Settings.userSettings.MiscSettings.ChatSpammer)
            {
                ...
                switch (t)
                {
                    ...
                    case 2: ClientCMD.Exec("say Get Mediocre, Get Barbudon."); break;
                    case 3: ClientCMD.Exec("say Don't cry if I kill you. It's just a good gaming chair."); break;
                    case 4: ClientCMD.Exec("say If you say Barbudon is shit, I won't argue, cause it is."); break;
                    case 5: ClientCMD.Exec("say Phansea owns Barbudon and me."); break;
